  ...
  return (
    <header className="bg-white/70 backdrop-blur-xl shadow-[0_12px_40px_-28px_rgba(26,42,79,0.35)] px-8 py-5">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          <button className="relative p-2 rounded-xl text-[#70798B] hover:bg-white/60 transition-all">
            <Bell className="w-5 h-5" />
            <span className="absolute -top-1 -right-1 bg-[#1A2A4F] text-white text-[10px] rounded-full w-5 h-5 flex items-center justify-center shadow-[0_6px_18px_-8px_rgba(26,42,79,0.6)]">
              3
            </span>
          </button>
          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="hidden sm:block text-[#4B5563]">
              <p className="text-sm font-semibold text-[#1A2A4F]">John Seller</p>
              <p className="text-xs">Premium Store</p>
            </div>
            <button
              onClick={onLogout}
